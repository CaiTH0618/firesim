...
def get_localhost_instance_info(url_ext: str) -> Optional[str]:
    ...
    # Treat both timeout (28) and "empty reply from server" (52) as
    # non-fatal -- return None to indicate metadata is unavailable.
    with settings(ok_ret_codes=[0, 28, 52]), hide('everything'):
